...
<div class="container grid-container">
	<div class="panel panel-default singular-download">
		<div class="panel-heading">
			<h3 class="panel-title"><i class="fa fa-file fa-fw"></i> <?= sprintf(___('You are ready to download "%s"'),'<a href="' . get_permalink($target_post->ID) . '">' . get_the_title($target_post->ID) . '</a>');?></h3>
		</div>
