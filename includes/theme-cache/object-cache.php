...
class WP_Object_Cache {
	...
	function __construct() {
		...
		if(!class_exists('Memcache')) die(sprintf('Your server is NOT support Memcache service, please delete %s and refresh page.',__FILE__));
