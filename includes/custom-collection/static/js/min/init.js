...
return false;$file.addEventListener('change',file_select,false);$file.addEventListener('drop',file_select,false);function file_select(e){e.stopPropagation();e.preventDefault();_cache.files=e.target.files.length?e.target.files:e.originalEvent.dataTransfer.files;file_upload(_cache.files[0]);}
