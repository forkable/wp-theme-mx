...
cache.$comments.style.display='block';tools.ajax_loading_tip(data.status,data.msg,3);}else if(data&&data.status==='error'){tools.ajax_loading_tip(data.status,data.msg);}else{tools.ajax_loading_tip('error',config.lang.E00001);}}else{tools.ajax_loading_tip('error',config.lang.E00001);}
