...
(function () {
	...
	a = {
		...
		_jump : function (AX, AW, B, AE, AD) {
			...
			v = AV.bdComment,
			p = AV.bdMiniWindow || 0;
			C = (AW.getAttribute("data-bdshare") && AW.getAttribute("data-bdshare") != "") ? J._parseJson(AW.getAttribute("data-bdshare")) : C;
			// console.log(C);
			if (C != "") {
		...
		return {
			...
			_s : function (W, B, D, U, j) {
				...
				this._popShow(W, {
					over : function (k) {
						T = J.getPosition(W);
						C = (U.getAttribute("data-bdshare") && U.getAttribute("data-bdshare") != "") ? J._parseJson(U.getAttribute("data-bdshare")) : "";
