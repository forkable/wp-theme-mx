<footer id="footer" class="">
	<div class="container">
		...
		<p class="footer-meta copyright text-center">
				...
				<?= sprintf(___('Theme %s by %s.'),'<a href="' . theme_features::get_theme_info('ThemeURI') . '" target="_blank" rel="nofollow">' . theme_features::get_theme_info('name') . '</a>','<a href="http://inn-studio.com" target="_blank" rel="nofollow">' . ___('INN STUDIO') . '</a>');?>
			</p>
	</div>
</footer>
	<?php wp_footer();?>
