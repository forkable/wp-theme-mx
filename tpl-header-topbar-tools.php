...
if(is_user_logged_in()){
	...
	<div class="btn-group btn-group-xs">
		...
		<?php if(class_exists('theme_custom_contribution')){ ?>
			<a href="<?php echo esc_url(theme_custom_contribution::get_tabs('contribution')['url']);?>" class="btn btn-default meta tool-contribution" title="<?php echo ___('Contribution');?>">
