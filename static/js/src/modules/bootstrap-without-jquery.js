...
(function() {
    ...
    function tabpanel(){
		...
		function action(e){
		    e.preventDefault();
		    var a = this,
		    	targetTabContent = document.getElementById(a.getAttribute('aria-controls')),
			    /** target parent */
			    targetParent = targetTabContent.parentNode,
				siblings = targetParent.parentNode.querySelectorAll('[data-toggle=tab]'),
			    /** other targetContents under the same parent */
			   	childTargetContents = targetParent.querySelectorAll('.tab-pane');
			/**
			 * active tab nav
			 */
			forEachElement(siblings,function(el,i){
				/** active the tab nav */
			    if(el.getAttribute('aria-controls') == a.getAttribute('aria-controls')){
			    	el.parentNode.classList.add('active');
			    /** set other tab nav to inactive */
		    	}else{
				    el.parentNode.classList.remove('active');
			    }
			});
			
		    forEachElement(childTargetContents,function(el,i){
			    /** active the tab content */
			    if(el.id == targetTabContent.id){
			    	el.classList.add('active');
			    /** set other targetTabContent to inactive */
		    	}else{
		 ...
		 * bind
		 */
	    forEachElement(tablists,function(tablist,i){
		    forEachElement(tablist.querySelectorAll('[data-toggle=tab]'),function(a,k){
