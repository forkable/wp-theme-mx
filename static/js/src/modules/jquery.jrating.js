...
require('theme_css/modules/jrating.css');
...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			...
			smallStarsPath : 'jrating/small.png', // path of the icon small.png
				...
				click : function(e){
					...
					if(opts.sendRequest) {
						$.ajax({
							...
							if(opts.done) opts.done(data,element,rate,textStatus,jqXHR);
						}).fail(function(jqXHR,textStatus,errorThrown){
							if(opts.fail) opts.fail(element,rate,textStatus,jqXHR);
						}).always(function(){
						...
						// $.post(opts.phpPath,{
							...
							// },
							// function(data) {
								// if(opts.ajax_callback) opts.ajax_callback( data,element, rate );
								// if(!data.error)
								// {
									// /** ONLY FOR THE DEMO, YOU CAN REMOVE THIS CODE **/
